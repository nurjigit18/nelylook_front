...
function Header() {
    ...
    const handleUserClick = async ()=>{
        // Check auth via httpOnly cookie session
        try {
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$front_nely$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL}/auth/me/`, {
                method: 'GET',
                credentials: 'include',
                headers: {
...
_s(Header, "5b2m9EFPwU9nZ04i4K/3Ne0Agzs=", false, function() {
    return [
...
_c = Header;
/* ===================== Helpers / Inline Components ===================== */ function SearchOverlay({ open, onClose }) {
    _s1();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$front_nely$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
...
//# sourceMappingURL=front_nely_components_4333ca76._.js.map